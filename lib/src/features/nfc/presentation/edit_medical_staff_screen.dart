                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _tf(s.name, _practNameCtrl, Icons.person),
                        const SizedBox(height: 12),
                        _dd(s.documentType, _practDocType, _docTypes, (v) {
                          if (v != null) setState(() => _practDocType = v);
                        }),
                        const SizedBox(height: 12),
                        _tf(s.documentNumber, _practDocNumberCtrl, Icons.badge),
                        const SizedBox(height: 20),
                        _sec(s.healthcareProvider),
                        const SizedBox(height: 12),
                        _tf(s.providerName, _providerNameCtrl, Icons.apartment),
                        const SizedBox(height: 12),
                        _tf(s.repsCode, _providerRepsCodeCtrl, Icons.qr_code),
                        const SizedBox(height: 20),
                        _sec(s.encounter),
                        const SizedBox(height: 12),
                        _tf(s.dateTime, _dateCtrl, Icons.calendar_today),
                        const SizedBox(height: 12),
