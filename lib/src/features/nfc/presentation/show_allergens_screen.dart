...
class _AD {
  ...
  final String name, category, reaction, notes;
}
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  const Icon(Icons.label, size: 18, color: AppColors.secondary),
                  const SizedBox(width: 8),
                  Text(
                    '${s.allergenOther}: ${_categoryLabel()}',
              ...
              if (a.reaction.isNotEmpty)
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text(a.reaction, style: const TextStyle(fontSize: 14)),
                  ],
                ),
              if (a.notes.isNotEmpty) ...[
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text(a.notes, style: const TextStyle(fontSize: 14)),
                  ],
                ),
              ],
            ],
