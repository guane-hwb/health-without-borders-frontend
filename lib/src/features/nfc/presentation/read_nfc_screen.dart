    ...
    switch (_state) {
      case _ScanState.idle:
        return _centerContent(
          ...
          title: _nfcAvailable ? s.scanWristband : s.manualUidHint,
          subtitle: s.readyToScan,
        );
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (_) => PatientProfileScreen(patient: _patient!),
                    ),
                  ),
                  style: ElevatedButton.styleFrom(
