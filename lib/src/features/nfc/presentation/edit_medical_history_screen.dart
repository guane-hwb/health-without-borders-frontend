...
class _EditMedicalHistoryScreenState extends State<EditMedicalHistoryScreen> {
  ...
  void initState() {
    ...
    _generalExamCtrl = TextEditingController(
      text: eval?.generalPhysicalExamination ?? '',
    );
    _systemsExamCtrl = TextEditingController(
      text: eval?.systemsExamination ?? '',
    );
    _treatmentPlanCtrl = TextEditingController(
      text: eval?.treatmentPlanObservations ?? '',
    );
  ...
  Future<void> _save() async {
    ...
    final updatedBg = BackgroundHistory(
      personalHistory: _personalHistoryCtrl.text.trim(),
      familyHistoryNotes: _familyHistoryNotesCtrl.text.trim(),
      familyHistory: _familyHistoryItems,
      chronicConditions: _chronicConditionItems,
    ...
    final newEval = ClinicalEvaluation(
      historyOfCurrentIllness: _currentIllnessCtrl.text.trim(),
      treatmentPlanObservations: _treatmentPlanCtrl.text.trim(),
      generalPhysicalExamination: _generalExamCtrl.text.trim(),
    ...
    try {
      ...
      AppLogger.e(
        'Error guardando historia médica',
        error: e,
        stackTrace: stack,
      );
    }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_chronicConditionItems.isEmpty)
                          ...
                          ..._chronicConditionItems.asMap().entries.map(
                            (e) => _ccCard(e.key, e.value),
                          ),
                        const SizedBox(height: 14),
                        Row(
                          children: [
                        ...
                        if (_medicationItems.isEmpty)
                          ...
                          ..._medicationItems.asMap().entries.map(
  ...
  Widget _ta(String label, TextEditingController c) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
  ...
  Widget _fhCard(int idx, FamilyHistoryItem item, AppStrings s) => Container(
    ...
    child: Row(
      children: [
        const Icon(Icons.family_restroom, size: 20, color: AppColors.secondary),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                '${s.relationship}: ${_relLabels[item.relationship] ?? item.relationship}',
                style: const TextStyle(
                  fontSize: 11,
                  color: AppColors.textSecondary,
                ),
        ...
        IconButton(
          ...
          onPressed: () => setState(() => _familyHistoryItems.removeAt(idx)),
        ),
      ],
    ),
  );
        ...
        builder: (ctx, ss) => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 14),
              Text(s.condition, style: const TextStyle(fontSize: 13)),
              const SizedBox(height: 4),
              TextField(
                controller: condCtrl,
              ...
              const SizedBox(height: 14),
              Text(s.relationship, style: const TextStyle(fontSize: 13)),
              const SizedBox(height: 4),
              Container(
  ...
  Widget _ccCard(int idx, ChronicConditionItem item) => Container(
    ...
    child: Row(
      children: [
        const Icon(Icons.favorite_border, size: 20, color: AppColors.secondary),
        const SizedBox(width: 10),
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
        ...
        IconButton(
          ...
          onPressed: () => setState(() => _chronicConditionItems.removeAt(idx)),
        ),
      ],
    ),
  );
    ...
    child: Row(
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                '${_medStatusLabel(item.status)}${item.dosage != null ? ' · ${item.dosage}' : ''}',
                style: const TextStyle(
                  fontSize: 11,
                  color: AppColors.textSecondary,
                ),
        ...
        IconButton(
          ...
          onPressed: () => setState(() => _medicationItems.removeAt(idx)),
        ),
      ],
    ),
  );
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 14),
            const Text('Condición', style: TextStyle(fontSize: 13)),
            const SizedBox(height: 4),
            TextField(
              controller: ctrl,
              decoration: const InputDecoration(
                hintText: 'ej: Diabetes mellitus tipo 2',
                isDense: true,
                contentPadding: EdgeInsets.all(12),
              ),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () {
                  ...
                  setState(
                    () => _chronicConditionItems.add(
                      ChronicConditionItem(
                        chronicDescription: ctrl.text.trim(),
                      ),
                    ),
                  );
                  Navigator.of(ctx).pop();
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 14),
            const Text('Medicamento', style: TextStyle(fontSize: 13)),
            const SizedBox(height: 4),
            TextField(
              controller: nameCtrl,
              decoration: const InputDecoration(
            ...
            const SizedBox(height: 14),
            const Text('Posología', style: TextStyle(fontSize: 13)),
            const SizedBox(height: 4),
            TextField(
